...
export declare class AggregateTransactionService {
     ...
     * @param cosignatures
     */
    static newAddCosignatures(signedTransaction: SignedTransaction, cosignatures: CosignatureSignedTransaction[]): SignedTransaction;
    /**
     * Appends cosignatures to a signed aggregate transaction, if they are not yet added
     *
     * @param signedTransaction
     ...
     * @param cosignatures
     */
    static addCosignaturesV1(signedTransaction: SignedTransaction, cosignatures: CosignatureSignedTransaction[]): SignedTransaction;
}
