...
class KeyPair {
     ...
     */
    static createKeyPairFromPrivateKeyString(privateKeyString, dScheme = DerivationScheme_1.DerivationScheme.Ed25519Sha3) {
        ...
        const publicKey = Utility.catapult_crypto.extractPublicKey(secretKey, Utility.getHasherFuncFromDerivationScheme(dScheme));
        return {
            privateKey,
            publicKey,
        };
     ...
     */
    static sign = (keyPair, data, dScheme = DerivationScheme_1.DerivationScheme.Ed25519Sha3) => {
     ...
     */
    static verify = (publicKey, data, signature, dScheme = DerivationScheme_1.DerivationScheme.Ed25519Sha3) => {
     ...
     */
    static deriveSharedKey(secretKey, publicKey, salt, version) {
