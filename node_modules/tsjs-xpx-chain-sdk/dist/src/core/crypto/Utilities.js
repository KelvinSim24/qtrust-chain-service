...
exports.catapult_crypto = exports.getHasherFromDerivationScheme = exports.getHasherFuncFromDerivationScheme = exports.getHasherFuncFromAccountVersion = exports.catapult_hash_sha2 = exports.catapult_hash_sha3 = exports.words2ua = exports.ua2words = exports.Half_Hash_Size = exports.Hash_Size = exports.Half_Signature_Size = exports.Signature_Size = exports.Key_Size = exports.CryptoJS = void 0;
/*
...
const SHA2Hasher_1 = require("./SHA2Hasher");
...
exports.catapult_hash_sha3 = {
    func: SHA3Hasher_1.SHA3Hasher.func,
    createHasher: SHA3Hasher_1.SHA3Hasher.createHasher,
};
exports.catapult_hash_sha2 = {
    func: SHA2Hasher_1.SHA2Hasher.func,
    createHasher: SHA2Hasher_1.SHA2Hasher.createHasher,
};
const getHasherFuncFromAccountVersion = (accVersion) => {
    if (accVersion === 2) {
        return exports.catapult_hash_sha2.func;
    }
    else {
        return exports.catapult_hash_sha3.func;
    }
};
exports.getHasherFuncFromAccountVersion = getHasherFuncFromAccountVersion;
const getHasherFuncFromDerivationScheme = (dScheme) => {
    if (dScheme === DerivationScheme_1.DerivationScheme.Ed25519Sha2) {
        return exports.catapult_hash_sha2.func;
    }
    else {
        return exports.catapult_hash_sha3.func;
...
exports.getHasherFuncFromDerivationScheme = getHasherFuncFromDerivationScheme;
const getHasherFromDerivationScheme = (dScheme) => {
    if (dScheme === DerivationScheme_1.DerivationScheme.Ed25519Sha2) {
        return exports.catapult_hash_sha2.createHasher(64);
    }
    else {
        return exports.catapult_hash_sha3.createHasher(64);
    }
};
exports.getHasherFromDerivationScheme = getHasherFromDerivationScheme;
...
exports.catapult_crypto = (function () {
    ...
    function prepareForScalarMult(sk, hashfunc) {
        ...
        hashfunc(d, sk, exports.Hash_Size);
        clamp(d);
        return d;
    }
