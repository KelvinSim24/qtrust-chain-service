...
export declare const catapult_hash_sha3: {
    func: (dest: any, data: Uint8Array, length: any) => void;
...
export declare const catapult_hash_sha2: {
...
export declare const getHasherFuncFromAccountVersion: (accVersion: number) => (dest: any, data: Uint8Array, length: any) => void;
export declare const getHasherFuncFromDerivationScheme: (dScheme: DerivationScheme) => (dest: any, data: Uint8Array, length: any) => void;
export declare const getHasherFromDerivationScheme: (dScheme: DerivationScheme) => {
    reset: () => void;
    update: (data: any) => void;
    finalize: (result: any) => void;
};
