...
class SHA3Hasher {
    ...
    static createHasher = (length = 64) => {
        ...
        return {
            ...
            finalize: (result) => {
                format_1.RawArray.copy(result, format_1.RawArray.uint8View(hash.digest()));
            },
        };
    };
    /**
     ...
     * @returns {object} The hasher.
     */
    static getHasher = (length = 64) => {
        return {
            32: sha3_1.sha3_256.create(),
            64: sha3_1.sha3_512.create()
        }[length];
    };
}
