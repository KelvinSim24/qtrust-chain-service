...
export declare class BlockHttp extends Http implements BlockRepository {
     ...
     */
    getBlockTransactions(height: number, txnQueryParam?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<Transaction[]>;
    /**
     * Gets array of transactions included in a block for a block height
     * @param height - Block height
     * @param txnQueryParam - (Optional) Transaction Query params
     ...
     */
    getBlockTransactionsWithPagination(height: number, txnQueryParam?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<TransactionSearch>;
    /**
     ...
     * @returns Observable<BlockInfo[]>
     */
    getBlocksByHeightWithLimit(height: number, limit?: LimitType, requestOptions?: RequestOptions): Observable<BlockInfo[]>;
    /**
