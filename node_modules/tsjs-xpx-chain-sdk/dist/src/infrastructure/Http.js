...
class Http {
    ...
    getNetworkTypeObservable(requestOptions) {
        let networkTypeResolve;
        if (this.networkType == null) {
            networkTypeResolve = this.networkHttp.getNetworkType(requestOptions).pipe((0, operators_1.map)((networkType) => {
                this.networkType = networkType;
                return networkType;
            }));
        }
        else {
            networkTypeResolve = (0, rxjs_1.of)(this.networkType);
        }
