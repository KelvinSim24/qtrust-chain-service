...
export declare class AccountHttp extends Http implements AccountRepository {
    ...
    getAccountsNames(addresses: Address[], requestOptions?: RequestOptions): Observable<AccountNames[]>;
    /**
     ...
     */
    transactions(publicAccount: PublicAccount, txnQueryParams?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<Transaction[]>;
    /**
     * Gets an array of confirmed transactions for which an account is signer or receiver.
     * @param publicAccount - User public account
     * @param txnQueryParams - (Optional) Transaction Query params
     ...
     */
    transactionsWithPagination(publicAccount: PublicAccount, txnQueryParams?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<TransactionSearch>;
    /**
     ...
     * @returns Observable<Transaction[]>
     */
    incomingTransactions(accountId: PublicAccount | Address, txnQueryParams?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<Transaction[]>;
    /**
     * Gets an array of transactions for which an account is the recipient of a transaction.
     * A transaction is said to be incoming with respect to an account if the account is the recipient of a transaction.
     * @param accountId - User public account or address (you can use address if public account is not known to the network just yet)
     ...
     * @returns Observable<TransactionSearch>
     */
    incomingTransactionsWithPagination(accountId: PublicAccount | Address, txnQueryParams?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<TransactionSearch>;
    /**
     ...
     * @returns Observable<Transaction[]>
     */
    outgoingTransactions(publicAccount: PublicAccount, txnQueryParams?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<Transaction[]>;
    /**
     * Gets an array of transactions for which an account is the sender a transaction.
     * A transaction is said to be outgoing with respect to an account if the account is the sender of a transaction.
     * @param publicAccount - User public account
     ...
     * @returns Observable<TransactionSearch>
     */
    outgoingTransactionsWithPagination(publicAccount: PublicAccount, txnQueryParams?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<TransactionSearch>;
    /**
     ...
     * @returns Observable<Transaction[]>
     */
    unconfirmedTransactions(publicAccount: PublicAccount, txnQueryParams?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<Transaction[]>;
    /**
     * Gets the array of transactions for which an account is the sender or receiver and which have not yet been included in a block.
     * Unconfirmed transactions are those transactions that have not yet been included in a block.
     * Unconfirmed transactions are not guaranteed to be included in any block.
     ...
     * @returns Observable<TransactionSearch>
     */
    unconfirmedTransactionsWithPagination(publicAccount: PublicAccount, txnQueryParams?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<TransactionSearch>;
    /**
     ...
     */
    aggregateBondedTransactions(publicAccount: PublicAccount, txnQueryParams?: TransactionQueryParams, requestOptions?: RequestOptions): Observable<AggregateTransaction[]>;
}
