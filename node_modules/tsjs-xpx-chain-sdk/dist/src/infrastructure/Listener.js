...
const TransactionMapUtility_1 = require("./transaction/TransactionMapUtility");
...
class Listener {
                ...
                this.webSocket.onmessage = (msg) => {
                    ...
                    if (message.uid) {
                        ...
                        this.messageSubject.next({
                            ...
                            message: new CosignatureSignedTransaction_1.CosignatureSignedTransaction(message.parentHash, message.signature, message.scheme, message.signer),
                        });
                    }
    ...
    newBlock() {
        ...
        return this.messageSubject
            .asObservable().pipe((0, operators_1.share)(), (0, operators_1.filter)((_) => _.channelName === ListenerChannelName.block), (0, operators_1.filter)((_) => _.message instanceof BlockInfo_1.BlockInfo), (0, operators_1.map)((_) => _.message));
    }
    /**
    ...
    confirmed(address) {
        ...
        return this.messageSubject.asObservable().pipe((0, operators_1.filter)((_) => _.channelName === ListenerChannelName.confirmedAdded), (0, operators_1.filter)((_) => _.message instanceof Transaction_1.Transaction), (0, operators_1.map)((_) => _.message), (0, operators_1.filter)((_) => this.transactionFromAddress(_, address)));
    }
    /**
     * Returns an observable stream of Transaction for a specific address.
    ...
    unconfirmedAdded(address) {
        ...
        return this.messageSubject.asObservable().pipe((0, operators_1.filter)((_) => _.channelName === ListenerChannelName.unconfirmedAdded), (0, operators_1.filter)((_) => _.message instanceof Transaction_1.Transaction), (0, operators_1.map)((_) => _.message), (0, operators_1.filter)((_) => this.transactionFromAddress(_, address)));
    }
    /**
    ...
    unconfirmedRemoved(address) {
        ...
        return this.messageSubject.asObservable().pipe((0, operators_1.filter)((_) => _.channelName === ListenerChannelName.unconfirmedRemoved), (0, operators_1.filter)((_) => typeof _.message === 'string'), (0, operators_1.map)((_) => _.message));
    }
    /**
    ...
    aggregateBondedAdded(address) {
        ...
        return this.messageSubject.asObservable().pipe((0, operators_1.filter)((_) => _.channelName === ListenerChannelName.aggregateBondedAdded), (0, operators_1.filter)((_) => _.message instanceof AggregateTransaction_1.AggregateTransaction), (0, operators_1.map)((_) => _.message), (0, operators_1.filter)((_) => this.transactionFromAddress(_, address)));
    }
    /**
     * Returns an observable stream of Transaction Hashes for specific address.
     * Each time an aggregate bonded transaction is announced,
    ...
    aggregateBondedRemoved(address) {
        ...
        return this.messageSubject.asObservable().pipe((0, operators_1.filter)((_) => _.channelName === ListenerChannelName.aggregateBondedRemoved), (0, operators_1.filter)((_) => typeof _.message === 'string'), (0, operators_1.map)((_) => _.message));
    }
    /**
    ...
    status(address) {
        ...
        return this.messageSubject.asObservable().pipe((0, operators_1.filter)((_) => _.channelName === ListenerChannelName.status), (0, operators_1.filter)((_) => _.message instanceof TransactionStatusError_1.TransactionStatusError), (0, operators_1.map)((_) => _.message));
    }
    /**
    ...
    cosignatureAdded(address) {
        ...
        return this.messageSubject.asObservable().pipe((0, operators_1.filter)((_) => _.channelName === ListenerChannelName.cosignature), (0, operators_1.filter)((_) => _.message instanceof CosignatureSignedTransaction_1.CosignatureSignedTransaction), (0, operators_1.map)((_) => _.message));
    }
    /**
     * @internal
