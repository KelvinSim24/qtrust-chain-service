...
exports.CreateReceiptFromDTO = exports.CreateStatementFromDTO = void 0;
...
const OfferCreationReceipt_1 = require("../../model/receipt/OfferCreationReceipt");
const OfferExchangeReceipt_1 = require("../../model/receipt/OfferExchangeReceipt");
const OfferRemovalReceipt_1 = require("../../model/receipt/OfferRemovalReceipt");
 ...
 * @constructor
 */
const CreateStatementFromDTO = (receiptDTO, networkType) => {
...
exports.CreateStatementFromDTO = CreateStatementFromDTO;
/**
 * @param receiptDTO
 * @param networkType
 * @returns {Receipt}
 * @constructor
 */
const CreateReceiptFromDTO = (receiptDTO, networkType) => {
    switch (receiptDTO.type) {
        ...
        case ReceiptType_1.ReceiptType.Offer_Creation:
            return createOfferCreationReceipt(receiptDTO, networkType);
        case ReceiptType_1.ReceiptType.Offer_Exchange:
            return createOfferExchangeReceipt(receiptDTO, networkType);
        case ReceiptType_1.ReceiptType.Offer_Removal:
...
const createTransactionStatement = (statementDTO, networkType) => {
    const knownReceiptTypes = Object.values(ReceiptType_1.ReceiptType);
    return new TransactionStatement_1.TransactionStatement(statementDTO.height, new ReceiptSource_1.ReceiptSource(statementDTO.source.primaryId, statementDTO.source.secondaryId), statementDTO.receipts
        .filter((receipt) => {
        return knownReceiptTypes.includes(receipt.type);
    })
        .map((receipt) => {
        return (0, exports.CreateReceiptFromDTO)(receipt, networkType);
    }));
};
/**
 * @internal
 ...
 * @constructor
 */
const createOfferCreationReceipt = (receiptDTO, networkType) => {
    return new OfferCreationReceipt_1.OfferCreationReceipt(PublicAccount_1.PublicAccount.createFromPublicKey(receiptDTO.sender, networkType), new MosaicId_1.MosaicId(receiptDTO.mosaicIdGive), new MosaicId_1.MosaicId(receiptDTO.mosaicIdGet), new UInt64_1.UInt64(receiptDTO.mosaicAmountGive), new UInt64_1.UInt64(receiptDTO.mosaicAmountGet), receiptDTO.version, receiptDTO.type);
};
/**
 * @internal
 * @param receiptDTO
 ...
 * @constructor
 */
const createOfferExchangeReceipt = (receiptDTO, networkType) => {
    return new OfferExchangeReceipt_1.OfferExchangeReceipt(PublicAccount_1.PublicAccount.createFromPublicKey(receiptDTO.sender, networkType), new MosaicId_1.MosaicId(receiptDTO.mosaicIdGive), new MosaicId_1.MosaicId(receiptDTO.mosaicIdGet), receiptDTO.exchangeDetails.map((exchangeDetail) => {
        return {
            recipient: Address_1.Address.createFromEncoded(exchangeDetail.recipient),
            mosaicIdGive: new MosaicId_1.MosaicId(exchangeDetail.mosaicIdGive),
            mosaicIdGet: new MosaicId_1.MosaicId(exchangeDetail.mosaicIdGet),
            mosaicAmountGive: new UInt64_1.UInt64(exchangeDetail.mosaicAmountGive),
            mosaicAmountGet: new UInt64_1.UInt64(exchangeDetail.mosaicAmountGet)
        };
    }), receiptDTO.version, receiptDTO.type);
};
/**
 * @internal
 * @param receiptDTO
 ...
 * @constructor
 */
const createOfferRemovalReceipt = (receiptDTO, networkType) => {
    return new OfferRemovalReceipt_1.OfferRemovalReceipt(PublicAccount_1.PublicAccount.createFromPublicKey(receiptDTO.sender, networkType), new MosaicId_1.MosaicId(receiptDTO.mosaicIdGive), new MosaicId_1.MosaicId(receiptDTO.mosaicIdGet), new UInt64_1.UInt64(receiptDTO.mosaicAmountGiveReturned), receiptDTO.version, receiptDTO.type);
};
