...
class DiagnosticHttp extends Http_1.Http {
     ...
     */
    getDiagnosticStorage(requestOptions) {
        return (0, rxjs_1.from)(this.diagnosticRoutesApi.getDiagnosticStorage(requestOptions))
     ...
     */
    getServerInfo(requestOptions) {
        return (0, rxjs_1.from)(this.diagnosticRoutesApi.getServerInfo(requestOptions))
            .pipe((0, operators_1.map)((response) => {
