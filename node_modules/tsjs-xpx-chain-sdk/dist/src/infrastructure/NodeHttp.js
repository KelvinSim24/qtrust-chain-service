...
class NodeHttp extends Http_1.Http {
     ...
     */
    getNodeInfo(requestOptions) {
        return (0, rxjs_1.from)(this.nodeRoutesApi.getNodeInfo(requestOptions)).pipe((0, operators_1.map)((response) => {
     ...
     */
    getNodeTime(requestOptions) {
        return (0, rxjs_1.from)(this.nodeRoutesApi.getNodeTime(requestOptions)).pipe((0, operators_1.map)((response) => {
