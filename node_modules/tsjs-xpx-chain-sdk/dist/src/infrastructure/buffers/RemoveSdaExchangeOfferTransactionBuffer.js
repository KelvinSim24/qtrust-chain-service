...
exports.RemoveSdaExchangeOfferTransactionBuffer = void 0;
const flatbuffers = require("flatbuffers");
const RemoveSdaExchangeOfferBuffer_1 = require("./RemoveSdaExchangeOfferBuffer");
class RemoveSdaExchangeOfferTransactionBuffer {
    bb = null;
    bb_pos = 0;
    __init(i, bb) {
        this.bb_pos = i;
    ...
    static getRootAsRemoveSdaExchangeOfferTransactionBuffer(bb, obj) {
        return (obj || new RemoveSdaExchangeOfferTransactionBuffer()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsRemoveSdaExchangeOfferTransactionBuffer(bb, obj) {
    ...
    sdaOffers(index, obj) {
        ...
        return offset ? (obj || new RemoveSdaExchangeOfferBuffer_1.RemoveSdaExchangeOfferBuffer()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index * 4), this.bb) : null;
    }
    sdaOffersLength() {
        const offset = this.bb.__offset(this.bb_pos, 20);
        return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
    }
    static startRemoveSdaExchangeOfferTransactionBuffer(builder) {
    ...
    static endRemoveSdaExchangeOfferTransactionBuffer(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createRemoveSdaExchangeOfferTransactionBuffer(builder, size, signatureOffset, signerOffset, version, type, maxFeeOffset, deadlineOffset, sdaOfferCount, sdaOffersOffset) {
...
exports.RemoveSdaExchangeOfferTransactionBuffer = RemoveSdaExchangeOfferTransactionBuffer;
//# sourceMappingURL=RemoveSdaExchangeOfferTransactionBuffer.js.map