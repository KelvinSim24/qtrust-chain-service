...
export declare class DataModificationTransactionBuffer {
    ...
    static startDataModificationTransactionBuffer(builder: flatbuffers.Builder): void;
    ...
    static addDownloadDataCdi(builder: flatbuffers.Builder, downloadDataCdiOffset: flatbuffers.Offset): void;
    static createDownloadDataCdiVector(builder: flatbuffers.Builder, data: number[] | Uint8Array): flatbuffers.Offset;
    static startDownloadDataCdiVector(builder: flatbuffers.Builder, numElems: number): void;
    static addUploadSize(builder: flatbuffers.Builder, uploadSizeOffset: flatbuffers.Offset): void;
    ...
    static startUploadSizeVector(builder: flatbuffers.Builder, numElems: number): void;
