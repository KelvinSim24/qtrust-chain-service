...
export declare class ReplicatorOnboardingTransactionBuffer {
    ...
    static startReplicatorOnboardingTransactionBuffer(builder: flatbuffers.Builder): void;
    ...
    static addCapacity(builder: flatbuffers.Builder, capacityOffset: flatbuffers.Offset): void;
    ...
    static startCapacityVector(builder: flatbuffers.Builder, numElems: number): void;
