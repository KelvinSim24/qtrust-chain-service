...
export declare class VerifiableTransaction {
     ...
     */
    static createTransactionHash(transactionPayload: any, generationHashBytes: any): string;
    /**
     ...
     */
    signTransaction(keyPair: any, generationHash: any, dScheme?: DerivationScheme): {
        payload: string;
        hash: string;
    };
    /**
     ...
     * @returns {module:model/TransactionPayload} - Signed Transaction Payload
     */
    static signTransactionPayload(txnPayload: string, keyPair: any, generationHash: any, dScheme?: DerivationScheme): {
        payload: string;
        hash: string;
    };
    serialize(): any;
     ...
     */
    newSignCosignatoriesTransaction(keyPair: any, dScheme?: DerivationScheme): {
        parentHash: string;
        signature: string;
        scheme: string;
        signer: any;
     ...
     * @returns {module:model/TransactionPayload} Returns TransactionPayload instance
     */
    signCosignatoriesTransactionV1(keyPair: any): {
        parentHash: string;
        signature: string;
        signer: any;
    };
