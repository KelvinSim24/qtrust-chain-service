...
class NamespaceHttp extends Http_1.Http {
     ...
     */
    getNamespace(namespaceId, requestOptions) {
        return this.getNetworkTypeObservable(requestOptions).pipe((0, operators_1.mergeMap)((networkType) => (0, rxjs_1.from)(this.namespaceRoutesApi.getNamespace(namespaceId.toHex(), requestOptions))
     ...
     * @returns Observable<NamespaceInfo[]>
     */
    getNamespacesFromAccount(address, queryParams, requestOptions) {
        return this.getNetworkTypeObservable(requestOptions).pipe((0, operators_1.mergeMap)((networkType) => (0, rxjs_1.from)(this.namespaceRoutesApi.getNamespacesFromAccount(address.plain(), this.queryParams(queryParams).pageSize, this.queryParams(queryParams).id, requestOptions)).pipe((0, operators_1.map)((response) => {
     ...
     * @returns Observable<NamespaceInfo[]>
     */
    getNamespacesFromAccounts(addresses, queryParams, requestOptions) {
        const publicKeysBody = {
            addresses: addresses.map((address) => address.plain()),
        };
        return this.getNetworkTypeObservable(requestOptions).pipe((0, operators_1.mergeMap)((networkType) => (0, rxjs_1.from)(this.namespaceRoutesApi.getNamespacesFromAccounts(publicKeysBody, this.queryParams(queryParams).pageSize, this.queryParams(queryParams).id, requestOptions)).pipe((0, operators_1.map)((response) => {
            return response.body.map((namespaceInfoDTO) => {
                return new NamespaceInfo_1.NamespaceInfo(namespaceInfoDTO.meta.active, namespaceInfoDTO.meta.index, namespaceInfoDTO.meta.id, namespaceInfoDTO.namespace.type, namespaceInfoDTO.namespace.depth, this.extractLevels(namespaceInfoDTO.namespace), new NamespaceId_1.NamespaceId(namespaceInfoDTO.namespace.parentId), PublicAccount_1.PublicAccount.createFromPublicKey(namespaceInfoDTO.namespace.owner, networkType), new UInt64_1.UInt64(namespaceInfoDTO.namespace.startHeight), new UInt64_1.UInt64(namespaceInfoDTO.namespace.endHeight), this.extractAlias(namespaceInfoDTO.namespace));
            });
        }))));
     ...
     */
    getNamespacesName(namespaceIds, requestOptions) {
        const namespaceIdsBody = {
            namespaceIds: namespaceIds.map((id) => id.toHex()),
        };
        return (0, rxjs_1.from)(this.namespaceRoutesApi.getNamespacesNames(namespaceIdsBody, requestOptions))
            .pipe((0, operators_1.map)((response) => {
     ...
     */
    getLinkedMosaicId(namespaceId, requestOptions) {
        return (0, rxjs_1.from)(this.namespaceRoutesApi.getNamespace(namespaceId.toHex(), requestOptions)).pipe((0, operators_1.map)((response) => {
            const namespaceInfoDTO = response.body;
     ...
     */
    getLinkedAddress(namespaceId, requestOptions) {
        return (0, rxjs_1.from)(this.namespaceRoutesApi.getNamespace(namespaceId.toHex(), requestOptions)).pipe((0, operators_1.map)((response) => {
            const namespaceInfoDTO = response.body;
            if (namespaceInfoDTO.namespace === undefined) {
                // forward js-xpx-chain-rest error
