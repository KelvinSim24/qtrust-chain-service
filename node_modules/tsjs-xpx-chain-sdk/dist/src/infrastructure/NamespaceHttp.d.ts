...
export declare class NamespaceHttp extends Http implements NamespaceRepository {
     ...
     * @returns Observable<NamespaceInfo[]>
     */
    getNamespacesFromAccount(address: Address, queryParams?: QueryParams, requestOptions?: RequestOptions): Observable<NamespaceInfo[]>;
    /**
     ...
     * @returns Observable<NamespaceInfo[]>
     */
    getNamespacesFromAccounts(addresses: Address[], queryParams?: QueryParams, requestOptions?: RequestOptions): Observable<NamespaceInfo[]>;
    /**
     ...
     */
    getLinkedMosaicId(namespaceId: NamespaceId, requestOptions?: RequestOptions): Observable<MosaicId>;
    /**
     * Gets the Address from a AddressAlias
     * @param namespaceId - the namespaceId of the namespace
     * @returns Observable<Address>
     */
    getLinkedAddress(namespaceId: NamespaceId, requestOptions?: RequestOptions): Observable<Address>;
