...
class ChainHttp extends Http_1.Http {
     ...
     */
    getBlockchainHeight(requestOptions) {
        return (0, rxjs_1.from)(this.chainRoutesApi.getBlockchainHeight(requestOptions))
     ...
     */
    getBlockchainScore(requestOptions) {
        return (0, rxjs_1.from)(this.chainRoutesApi.getBlockchainScore(requestOptions))
            .pipe((0, operators_1.map)((response) => {
