...
export declare class SimpleWallet extends Wallet {
     ...
     */
    static create(name: string, password: Password, network: NetworkType, version?: number): SimpleWallet;
    /**
     ...
     * @returns {SimpleWallet}
     */
    static createFromPrivateKey(name: string, password: Password, privateKey: string, network: NetworkType, version?: number): SimpleWallet;
    /**
     * Create a SimpleWallet from private key
     * @param name - Wallet name
     ...
     * @returns {SimpleWallet}
     */
    static createFromEncryptedKey(name: string, encryptedKey: string, iv: string, publicKey: string, network: NetworkType, version?: number): SimpleWallet;
    /**
