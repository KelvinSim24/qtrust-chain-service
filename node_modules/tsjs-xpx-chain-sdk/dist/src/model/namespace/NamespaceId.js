...
class NamespaceId {
    ...
    static createFromEncoded(encoded) {
        const namespace = new NamespaceId(Id_1.Id.fromHex(format_1.Convert.hexReverse(encoded)).toDTO());
        return namespace;
    }
    /**
    ...
    static createFromHex(hexString) {
        const namespace = new NamespaceId(Id_1.Id.fromHex(hexString).toDTO());
        return namespace;
    }
    /**
