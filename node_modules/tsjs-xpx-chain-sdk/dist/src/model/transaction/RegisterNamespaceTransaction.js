...
exports.RegisterSubNamespaceTransactionBuilder = exports.RegisterRootNamespaceTransactionBuilder = exports.RegisterNamespaceTransaction = void 0;
...
class RegisterSubNamespaceTransactionBuilder extends Transaction_1.TransactionBuilder {
    ...
    build() {
        const parentId = this._parentNamespace instanceof NamespaceId_1.NamespaceId ? this._parentNamespace :
        ...
        let namespaceId = this._parentNamespace instanceof NamespaceId_1.NamespaceId ?
            new NamespaceId_1.NamespaceId(infrastructure_1.NamespaceMosaicIdGenerator.subNamespaceIdWithParentId(this._parentNamespace.id.toDTO(), this._namespaceName)) :
