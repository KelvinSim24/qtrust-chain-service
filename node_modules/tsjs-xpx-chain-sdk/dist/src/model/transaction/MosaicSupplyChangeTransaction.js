...
exports.MosaicSupplyChangeTransactionBuilder = exports.MosaicSupplyChangeTransaction = void 0;
...
class MosaicSupplyChangeTransactionBuilder extends Transaction_1.TransactionBuilder {
    ...
    build() {
        return new MosaicSupplyChangeTransaction(this._networkType, this._version || TransactionTypeVersion_1.TransactionTypeVersion.MOSAIC_SUPPLY_CHANGE, this._deadline ? this._deadline : this._createNewDeadlineFn(), this._maxFee ? this._maxFee : (0, FeeCalculationStrategy_1.calculateFee)(MosaicSupplyChangeTransaction.calculateSize(), this._feeCalculationStrategy), this._mosaicId, this._direction, this._delta, this._signature, this._signer, this._transactionInfo);
    }
}
