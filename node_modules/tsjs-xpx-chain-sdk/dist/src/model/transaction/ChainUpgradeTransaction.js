...
exports.ChainUpgradeTransactionBuilder = exports.ChainUpgradeTransaction = void 0;
...
class ChainUpgradeTransactionBuilder extends Transaction_1.TransactionBuilder {
    ...
    build() {
        return new ChainUpgradeTransaction(this._networkType, this._version || TransactionTypeVersion_1.TransactionTypeVersion.CHAIN_UPGRADE, this._deadline ? this._deadline : this._createNewDeadlineFn(), this._maxFee ? this._maxFee : (0, FeeCalculationStrategy_1.calculateFee)(ChainUpgradeTransaction.calculateSize(), this._feeCalculationStrategy), this._upgradePeriod, this._newBlockchainVersion, this._signature, this._signer, this._transactionInfo);
    }
}
