...
export declare abstract class Transaction {
     ...
     */
    newSignWith(account: Account, generationHash: string): SignedTransaction;
    /**
     * Serialize and sign transaction creating a new SignedTransaction
     * @param account - The account to sign the transaction
     * @param generationHash - Network generation hash hex
     * @returns {SignedTransaction}
     */
    signWith(account: Account, generationHash: string): SignedTransaction;
    static signPayload(txnPayload: string, account: Account, generationHash: string): SignedTransaction;
    /**
     * Convert an aggregate transaction to an inner transaction including transaction signer.
     * @param signer - Transaction signer.
     * @returns InnerTransaction
     */
    toNewAggregate(signer: PublicAccount): InnerTransaction;
    /**
     * Convert an aggregate transaction to an inner transaction including transaction signer.
     * @param signer - Transaction signer.
     * @returns InnerTransaction
     ...
     * @returns InnerTransaction
     */
    toAggregateV1(signer: PublicAccount): InnerTransaction;
    /**
