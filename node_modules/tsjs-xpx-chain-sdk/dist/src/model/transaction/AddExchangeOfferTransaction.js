...
exports.AddExchangeOfferTransactionBuilder = exports.AddExchangeOfferTransaction = void 0;
...
class AddExchangeOfferTransactionBuilder extends Transaction_1.TransactionBuilder {
    ...
    build() {
        return new AddExchangeOfferTransaction(this._networkType, this._version || TransactionTypeVersion_1.TransactionTypeVersion.ADD_EXCHANGE_OFFER, this._deadline ? this._deadline : this._createNewDeadlineFn(), this._offers, this._maxFee ? this._maxFee : (0, FeeCalculationStrategy_1.calculateFee)(AddExchangeOfferTransaction.calculateSize(this._offers.length), this._feeCalculationStrategy), this._signature, this._signer, this._transactionInfo);
    }
}
