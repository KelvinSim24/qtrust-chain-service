...
exports.RemoveExchangeOfferTransactionBuilder = exports.RemoveExchangeOfferTransaction = void 0;
...
class RemoveExchangeOfferTransactionBuilder extends Transaction_1.TransactionBuilder {
    ...
    build() {
        return new RemoveExchangeOfferTransaction(this._networkType, this._version || TransactionTypeVersion_1.TransactionTypeVersion.REMOVE_EXCHANGE_OFFER, this._deadline ? this._deadline : this._createNewDeadlineFn(), this._offers, this._maxFee ? this._maxFee : (0, FeeCalculationStrategy_1.calculateFee)(RemoveExchangeOfferTransaction.calculateSize(this._offers.length), this._feeCalculationStrategy), this._signature, this._signer, this._transactionInfo);
    }
}
