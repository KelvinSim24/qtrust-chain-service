...
exports.SecretLockTransactionBuilder = exports.SecretLockTransaction = void 0;
/*
 * Copyright 2018 NEM
 *
...
class SecretLockTransaction extends Transaction_1.Transaction {
    ...
    recipient, signature, signer, transactionInfo) {
        ...
        if (!(0, HashType_1.HashTypeLengthValidator)(hashType, this.secret)) {
...
class SecretLockTransactionBuilder extends Transaction_1.TransactionBuilder {
    ...
    build() {
        return new SecretLockTransaction(this._networkType, this._version || TransactionTypeVersion_1.TransactionTypeVersion.SECRET_LOCK, this._deadline ? this._deadline : this._createNewDeadlineFn(), this._maxFee ? this._maxFee : (0, FeeCalculationStrategy_1.calculateFee)(SecretLockTransaction.calculateSize(), this._feeCalculationStrategy), this._mosaic, this._duration, this._hashType, this._secret, this._recipient, this._signature, this._signer, this._transactionInfo);
    }
}
