...
exports.AccountLinkTransactionBuilder = exports.AccountLinkTransaction = void 0;
...
class AccountLinkTransactionBuilder extends Transaction_1.TransactionBuilder {
    ...
    build() {
        return new AccountLinkTransaction(this._networkType, this._version || TransactionTypeVersion_1.TransactionTypeVersion.LINK_ACCOUNT, this._deadline ? this._deadline : this._createNewDeadlineFn(), this._maxFee ? this._maxFee : (0, FeeCalculationStrategy_1.calculateFee)(AccountLinkTransaction.calculateSize(), this._feeCalculationStrategy), this._remoteAccountKey, this._linkAction, this._signature, this._signer, this._transactionInfo);
    }
}
