...
exports.ModifyMultisigAccountTransactionBuilder = exports.ModifyMultisigAccountTransaction = void 0;
...
class ModifyMultisigAccountTransactionBuilder extends Transaction_1.TransactionBuilder {
    ...
    build() {
        return new ModifyMultisigAccountTransaction(this._networkType, this._version || TransactionTypeVersion_1.TransactionTypeVersion.MODIFY_MULTISIG_ACCOUNT, this._deadline ? this._deadline : this._createNewDeadlineFn(), this._maxFee ? this._maxFee : (0, FeeCalculationStrategy_1.calculateFee)(ModifyMultisigAccountTransaction.calculateSize(this._modifications.length), this._feeCalculationStrategy), this._minApprovalDelta, this._minRemovalDelta, this._modifications, this._signature, this._signer, this._transactionInfo);
    }
}
