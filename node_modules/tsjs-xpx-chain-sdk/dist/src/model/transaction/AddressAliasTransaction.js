...
exports.AddressAliasTransactionBuilder = exports.AddressAliasTransaction = void 0;
...
class AddressAliasTransactionBuilder extends Transaction_1.TransactionBuilder {
    ...
    build() {
        return new AddressAliasTransaction(this._networkType, this._version || TransactionTypeVersion_1.TransactionTypeVersion.ADDRESS_ALIAS, this._deadline ? this._deadline : this._createNewDeadlineFn(), this._maxFee ? this._maxFee : (0, FeeCalculationStrategy_1.calculateFee)(AddressAliasTransaction.calculateSize(), this._feeCalculationStrategy), this._actionType, this._namespaceId, this._address, this._signature, this._signer, this._transactionInfo);
    }
}
