...
exports.AccountAddressRestrictionModificationTransactionBuilder = exports.AccountAddressRestrictionModificationTransaction = void 0;
...
class AccountAddressRestrictionModificationTransactionBuilder extends Transaction_1.TransactionBuilder {
    ...
    build() {
        return new AccountAddressRestrictionModificationTransaction(this._networkType, this._version || TransactionTypeVersion_1.TransactionTypeVersion.MODIFY_ACCOUNT_RESTRICTION_ADDRESS, this._deadline ? this._deadline : this._createNewDeadlineFn(), this._maxFee ? this._maxFee : (0, FeeCalculationStrategy_1.calculateFee)(AccountAddressRestrictionModificationTransaction.calculateSize(this._modifications.length), this._feeCalculationStrategy), this._restrictionType, this._modifications, this._signature, this._signer, this._transactionInfo);
    }
}
