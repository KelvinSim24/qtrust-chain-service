...
class MosaicExchange {
    ...
    static createFromDTO(exchangesDTO, networkType) {
        ...
        return new MosaicExchange(new MosaicId_1.MosaicId(exchangesDTO.mosaicId), owner, new UInt64_1.UInt64(exchangesDTO.amount), exchangesDTO.price, new UInt64_1.UInt64(exchangesDTO.initialAmount), new UInt64_1.UInt64(exchangesDTO.initialCost), new UInt64_1.UInt64(exchangesDTO.deadline));
    }
}
